...
const getVisibleColumns = function (isSelectable, visibleColumns) {
  let additionalColumns = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : [];
  let manualSelectColumn = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : selectColumn;
  let columns = [];
  if (isSelectable) {
