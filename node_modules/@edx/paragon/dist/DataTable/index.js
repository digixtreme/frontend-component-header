const _excluded = ["columns", "data", "defaultColumnValues", "additionalColumns", "isSelectable", "isPaginated", "manualPagination", "pageCount", "itemCount", "isFilterable", "manualFilters", "fetchData", "initialState", "isSortable", "manualSortBy", "isExpandable", "renderRowSubComponent", "bulkActions", "tableActions", "numBreakoutFilters", "initialTableOptions", "EmptyTableComponent", "manualSelectColumn", "showFiltersInSidebar", "dataViewToggleOptions", "disableElevation", "isLoading", "children", "onSelectedRowsChanged"];
...
function DataTable(_ref) {
  ...
  const defaultColumn = useMemo(() => defaultColumnValues, [defaultColumnValues]);
  const tableOptions = useMemo(() => {
    const updatedTableOptions = _objectSpread({
  ...
  tableArgs.push(hooks => {
    hooks.visibleColumns.push(visibleColumns => getVisibleColumns(isSelectable, visibleColumns, additionalColumns, manualSelectColumn));
  });
  ...
  if (selectedRows.length > 0) {
    ...
    tableArgs.push(hooks => {
      hooks.useControlledState.push(state => _objectSpread(_objectSpread({}, state), {}, {
