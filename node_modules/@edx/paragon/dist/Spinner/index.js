const _excluded = ["className", "screenReaderText"];
...
const Spinner = /*#__PURE__*/React.forwardRef((_ref, ref) => {
  ...
  const spinnerProps = _objectSpread(_objectSpread({}, attrs), {}, {
    className: classNames('pgn__spinner', className),
    role: screenReaderText ? 'status' : undefined
  });
  return /*#__PURE__*/React.createElement(BaseSpinner, _extends({}, spinnerProps, {
    ref: ref
